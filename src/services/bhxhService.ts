...
export class BhxhService {
  ...
  async mockLookupBhxhInfo(maSoBHXH: string): Promise<BhxhLookupResponse> {
    // Simulate API delay
    ...
    if (maSoBHXH === '0123456789') {
      return {
        ...
        data: {
          ...
          ngayThamGia: '01/01/2020',
          ngayNgungThamGia: '',
          mucLuong: '5000000',
          tyLeDong: '8%',
          soTienDong: '400000',
          donViThuTien: 'BHXH Quận 2',
          tinhTrangDongPhi: 'Đã đóng đủ'
        },
        message: 'Tra cứu thông tin BHXH tự nguyện thành công'
      };
    } else if (maSoBHXH === '9876543210') {
      return {
        success: true,
        data: {
          maSoBHXH: '9876543210',
          ...
          ngaySinh: '20/08/1990',
          gioiTinh: 'Nữ',
          diaChi: '789 Đường GHI, Phường XYZ, Quận 3, TP.HCM',
          soDienThoai: '0912345678',
          cmnd: '987654321098',
          trangThaiThamGia: 'Tạm ngừng',
          ngayThamGia: '15/06/2018',
          ngayNgungThamGia: '30/12/2023',
          mucLuong: '4500000',
          tyLeDong: '8%',
          soTienDong: '360000',
          donViThuTien: 'BHXH Quận 3',
          tinhTrangDongPhi: 'Còn nợ 2 tháng'
        },
        message: 'Tra cứu thông tin BHXH tự nguyện thành công'
      };
    } else {
      return {
        success: false,
        message: 'Không tìm thấy thông tin BHXH tự nguyện với mã số này'
      };
    }
  }

  // Mock function for bulk lookup testing
  async mockBulkLookupBhxhInfo(
    maSoBHXHList: string[],
    onProgress?: (progress: BulkLookupProgress) => void
  ): Promise<BhxhBulkLookupResponse> {
    const results: BhxhBulkResult[] = [];
